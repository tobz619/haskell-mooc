...
composeRates :: Rate currencya currencyb -> Rate currencyb currencyc -> Rate currencya currencyc 
...
data First
data Last
newtype Name firstlast = Name String 
  deriving Show
...
capitalize :: Name firstlast -> Name firstlast
